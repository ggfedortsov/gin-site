...
export function About({ currentLang }: AboutProps) {
  const translations = {
    ru: {
      ...
      p1: 'Я, Катерина Крутько — врач акушер-гинеколог, гинеколог-эстетист, высшей категории, с опытом работы более 18 лет. Специализируюсь на диагностике и лечении широкого спектра гинекологических заболеваний, ведении беременности и профилактике женских заболеваний. Имею большой опыт работы с детьми и подростками.',
    ...
    uk: {
      ...
      p1: 'Я, Катерина Крутько — лікар акушер-гінеколог, гінеколог-естетист, вищої категорії, з досвідом роботи більше 18 років. Спеціалізуюсь на діагностиці та лікуванні широкого спектру гінекологічних захворювань, веденні вагітності та профілактиці жіночих захворювань. Маю великий досвід роботи з дітьми та підлітками.',
